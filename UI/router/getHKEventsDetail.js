module.exports.getHKEventsDetail = function(req,res,logger){
      ...
      let q = "select Title,Start_time,Description,url,venue_name,venue_address,image from `hive_social_media`.`default`.`HKEvents` where Id = '" + id + "'";
