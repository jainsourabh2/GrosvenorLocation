...
function getQueryForSalesData(robj)
{
  ...
  let query1Period=""
  let query1Next = " from (SELECT SUM(CAST(S.SalesValue as int)) as totalcount,S.StoreName as storename,S.Zone,M.Latitude,M.Longitude,S.YearPeriod,M.Id,M.FloorLevel,S.Period";
