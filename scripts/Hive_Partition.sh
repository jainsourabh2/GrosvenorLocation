...
newdata_command=$" hive -e \"ALTER TABLE newtwittercategorystream ADD PARTITION(create_date='$new_date') location '/grosvenor/twitter/newtwittercategoryflume/$new_date';\" "
