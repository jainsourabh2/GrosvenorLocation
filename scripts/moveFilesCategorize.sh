#!/bin/bash
basePath="/grosvenor/twitter/twittercategoryflume/"
for filePath in $(hdfs dfs -find /grosvenor/twitter/twittercategoryflume/current/*.txt)
do
        ...
        localBasePath="/opt/nodeprojects/GrosvenorLocation/scripts/moving_categorize/"
